	...
	public class FormModeTester
	{
		...
		public void modify_the_tag_for_ajax()
		{
			formForMode(FormMode.Ajax)
				.ToString().ShouldEqual("<form method=\"post\" action=\"test\" data-form-mode=\"ajax\" class=\"activated-form\">");
		}
		...
		public void modify_the_tag_for_lofi()
		{
			formForMode(FormMode.LoFi)
				.ToString().ShouldEqual("<form method=\"post\" action=\"test\" data-form-mode=\"lofi\" class=\"activated-form\">");
		}
